...
enum StartupStatus { initial, loading, ready, error }

enum StartupDestination { none, login, onboarding, home }
...
class AppStartupState extends Equatable {
  ...
  const AppStartupState.ready({required this.destination, this.user})
